...
class MetaLearner(object):
    def __init__(self, device, lr):
        ...
        self.emb_net = torch.nn.DistributedDataParallel(self.emb_net, device_ids=[0, 1, 2, 3])
        self.ctr_net = torch.nn.DistributedDataParallel(self.ctr_net, device_ids=[0, 1, 2, 3])
